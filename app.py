...
def plot():
    ...
    # 첫 번째 y축 (왼쪽)
    ax1.plot(x_labels1, y_values1, marker='o', linestyle='-', color='lightseagreen', label='평균 소비', linewidth=1, markersize=4)
    ...
    ax2.plot(x_labels2, y_values2, marker='o', linestyle='-', color='darkslategray', label='빈도', linewidth=1, markersize=4)
